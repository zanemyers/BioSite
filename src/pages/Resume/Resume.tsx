import { FiCalendar, FiDownload, FiGlobe, FiMail, FiMapPin, FiPhone } from 'react-icons/fi';
          ...
          <div className="bg-card shadow-lg rounded-lg p-8 mb-8">
            ...
            <div className="flex flex-wrap gap-4 text-sm text-muted-foreground w-full">
              <div className="flex items-center gap-2 flex-1 min-w-[220px]">
                ...
                <span className="whitespace-nowrap">zane15myers@gmail.com</span>
              </div>
              ...
              <div className="flex items-center gap-2 flex-1 min-w-[180px]">
                ...
                <span className="whitespace-nowrap">+1 (620) 504-2094</span>
              </div>
              ...
              <div className="flex items-center gap-2 flex-1 min-w-[160px]">
                ...
                <span className="whitespace-nowrap">St. George, KS</span>
              </div>
              ...
              <div className="flex items-center gap-2 flex-1 min-w-[120px]">
                ...
                <span className="whitespace-nowrap">zm1.org</span>
              </div>
            </div>
